    ...
    <table class="tablelist">
        ...
        <c:forEach items="${companyList}" var="company">
            <tr>
                ...
                <td><a href="/adminCompanyManager/seeCompany?companyId=${company.id}" class="tablelink">查看</a><a href="/adminCompanyManager/auditCompany?companyId=${company.id}" class="tablelink">审核</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
